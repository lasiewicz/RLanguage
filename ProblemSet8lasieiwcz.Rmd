...
```{r}
first.column.win.probability <- 12/37
expectednumberoflossesbeforfirstwin<-(1 - first.column.win.probability) / first.column.win.probability
cat (expectednumberoflossesbeforfirstwin)
cat("\n")
varianceofnumberlossesbeforfirstwin<-(1 - first.column.win.probability) / first.column.win.probability^2
